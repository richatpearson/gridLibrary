...
extern NSString *const PGMAuthForgotUsername;
extern NSString *const PGMAuthForgotPassword;
extern NSString *const PGMAuthForgotUsernameEmailNotFound;
extern NSString *const PGMAuthForgotPasswordNoSuchUsername;
extern NSString *const PGMAuthForgotPasswordTooManyTickets;
