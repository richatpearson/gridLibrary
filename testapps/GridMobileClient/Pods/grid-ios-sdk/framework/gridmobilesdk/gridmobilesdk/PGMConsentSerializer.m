...
- (PGMAuthResponse*) deserializeConsentPoliciesData:(NSData*)data
    ...
    {
        response.error =
        [PGMError createErrorForErrorCode:PGMAuthConsentFlowError andDescription:@"Escrow Policies API returned no data"];
        return response;
    }
...
- (PGMAuthResponse*) deserializePostedConsentPoliciesData:data
    ...
    {
        response.error =
        [PGMError createErrorForErrorCode:PGMAuthConsentFlowError andDescription:@"Post user consent policies API returned no data"];
        return response;
    }
