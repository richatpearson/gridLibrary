...
typedef NS_ENUM(NSInteger, PGMClientErrorCode)
{
    ...
    PGMAuthInvalidEmailError                = 16,
    PGMAuthEmailNotFound                    = 17,
    PGMAuthUnknownForgotUsernameError       = 18,
    PGMAuthUnknownForgotPasswordError       = 19,
    PGMAuthMissingUsernameError             = 20,
    PGMAuthUsernameNotFoundError            = 21,
    PGMAuthMaxForgotPasswordExceededError   = 22,
    PGMAuthMissingAccessTokenInContextError = 23,
    PGMProviderReturnedNoDataError          = 24
};
